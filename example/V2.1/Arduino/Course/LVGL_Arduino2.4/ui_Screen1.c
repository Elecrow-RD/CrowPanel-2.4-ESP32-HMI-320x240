...
// Button event functions update the shared LED state used by the main loop.
void ui_event_Button1(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);

    if(event_code == LV_EVENT_CLICKED) {
        // A click on ON requests a high level on GPIO25.
        led = 1;
    }
}
...
void ui_event_Button2(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        // A click on OFF requests a low level on GPIO25.
        led = 0;
    }
}

// Build the generated screen, labels, and image buttons.
